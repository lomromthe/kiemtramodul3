...
public class StudentDAO {
    ...
    public static List<Student> getAllStudents() {
        ...
        String sql = "select * from quanlyhocvien";
        try {
    ...
    public static boolean edit(Student student) {
        String sql = "update quanlyhocvien set name=?, dateOfBirth=?, address=?, phone=?, email=?, classroom=? where id=?";
        try {
    ...
    public static Student findStudentById(int id) {
        String sql = "select * from quanlyhocvien where id=" + id;
        try {
            Statement statement = connection.createStatement();
            ResultSet resultSet = statement.executeQuery(sql);
            resultSet.next();
    ...
    public static void deleteStudent(int id) {
        String sql = "Delete from quanlyhocvien where id=" + id;
        try {
            Statement statement = connection.createStatement();
    ...
    public static boolean save(Student student) {
        String sql = "INSERT INTO quanlyhocvien VALUES (?,?,?,?,?,?,?)";
        try {
            PreparedStatement preparedStatement =connection.prepareStatement(sql);
    ...
    public static List<Student> search(String str) {
        ...
        String sql = "SELECT * FROM quanlyhocvien WHERE name like " + "'%"+str+"%'";
        try {
            Statement statement = connection.createStatement();
            ResultSet resultSet = statement.executeQuery(sql);
            while (resultSet.next()) {
